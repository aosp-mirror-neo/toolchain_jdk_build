#!/bin/bash
#
# builds JBR25 for Windows. Expected to be called from build-jbr25-win-x64.cmd wrapper


echo "In toolchain\jdk\build\build-jbr25-win-x64.sh..."
...
declare -r boot_jdk="$top/prebuilts/jdk/studio/jbr25/win"
