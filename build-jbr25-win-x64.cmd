@rem  Builds JetBrainsRuntime JDK25 for Windows.
@rem  Usage:
@rem   build-jbr25-win-x64.cmd [-q]
...
@echo "In build-jbr25-win-x64.cmd"
...
%CYGWIN_DIR%\bin\bash -l %SCRIPT_DIR%build-jbr25-win-x64.sh %QUIET%